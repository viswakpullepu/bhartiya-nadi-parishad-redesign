...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F6FAFC] text-[#0A1D33] font-sans selection:bg-[#2B8EE8]/20 selection:text-[#0A1D33]">
      {/* Navigation */}
      <Navbar onOpenJoinModal={() => setJoinModalOpen(true)} />

      {/* Main Content Sections */}
      <main>
        {/* 1. Hero Section with Pine Labs Masked Typography */}
        <Hero
        ...
        {/* 3. River Basins & Field Blueprints Showcase */}
        <RiverExplorer />
      ...
      {/* River Warrior Registration Modal */}
      <JoinModal
